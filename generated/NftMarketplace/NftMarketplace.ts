...
export class NftVoucherBoughtCall extends ethereum.Call {
  get inputs(): NftVoucherBoughtCall__Inputs {
    return new NftVoucherBoughtCall__Inputs(this);
  }

  get outputs(): NftVoucherBoughtCall__Outputs {
    return new NftVoucherBoughtCall__Outputs(this);
  }
}

export class NftVoucherBoughtCall__Inputs {
  _call: NftVoucherBoughtCall;

  constructor(call: NftVoucherBoughtCall) {
    this._call = call;
  }
...
export class NftVoucherBoughtCall__Outputs {
  _call: NftVoucherBoughtCall;
